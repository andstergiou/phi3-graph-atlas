...
NOTE = (
    ...
    'value is in minimal subtraction (MS-bar).  beta, Z_lambda, '
    ...
    'the number of distinct labellings: orbit = 6/stab for a vertex structure, '
    ...
    'On is the O(n) value of a single term of the orbit, so a structure '
    'contributes coefficient*orbit*On at O(n); gamma_phi_On is that '
    'contribution for a propagator structure, both orientations included.  '
