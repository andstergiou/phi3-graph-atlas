...
NOTE = (
    ...
    'value is in minimal subtraction (MS-bar).  beta and Z_lambda are in the '
    'O-normalisation: coefficients of the structure summed over its distinct '
    'external labellings, so beta_L = L times the 1/epsilon residue of '
    'Z_lambda.  stab is the number of permutations of the external indices '
    'that leave a structure\'s tensor unchanged and orbit = 6/stab the number '
    'of distinct labellings.  (Z_lambda here is orbit times smaller than the '
    'coefficient of Tbar, the average over all 6 permutations.)  gamma_phi is '
    '-L times the 1/epsilon residue of Zphi_minus_half.  '
