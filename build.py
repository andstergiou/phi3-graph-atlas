...
NOTE = (
    ...
    'stab is the number of permutations of the external indices that leave a '
    'structure\'s tensor unchanged and orbit = 6/stab the number of distinct '
    'tensors they produce; Tbar is the average over all 6 permutations, which '
    'is the O sum divided by orbit.  '
